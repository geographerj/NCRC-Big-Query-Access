"""
Generate optimized HMDA peer SQL query for goal-setting analysis.
Uses 50%-200% volume rule for peer selection.
"""

def build_peer_hmda_query(
    subject_lei: str,
    ...
    """
    Build optimized HMDA query for peer banks (50%-200% volume rule).
    ...
    if loan_purpose:
        ...
        if loan_purpose_group == 'home_purchase':
            ...
            loan_purpose_filter = "    AND h.loan_purpose IN ('31', '32')  -- Refinance"
...
peers AS (
    ...
    WHERE al.lei != '{subject_lei}'  -- Exclude subject bank
