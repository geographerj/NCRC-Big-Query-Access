...
Uses pathlib to handle apostrophe in path.

This file contains the full code - can be double-clicked or run directly.
Bypasses terminal wrapper issues by being self-contained.
"""
...
print("=" * 80)
# Remove input() so it can be run programmatically
