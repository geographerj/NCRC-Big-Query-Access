"""
Move all PNC/FirstBank related files from OneDrive folder to the merger folder.
Searches for ALL files with PNC or FirstBank/First Bank in the name.
Uses pathlib to handle apostrophe in path - workaround for shell issues.

To run: python utils/run_python_script.py organize_pnc_onedrive_files.py
"""
...
print(f"\nCompleted! Moved {moved_count} files, skipped {skipped_count} files (already in merger folder).")
